...
class SongRecommenderApp:
    ...
    def search_and_recommend(self, find_least_similar=False):
        ...
        similarity_scores = cosine_similarity(song_features, pool_features)
        ...
        if find_least_similar:
            # Sort ascending for least similar
    ...
    def get_similar_songs(self, song_idx, num_recommendations=5):
        ...
        similarities = cosine_similarity(song_features, self.normalized_features)[0]
        ...
        for idx in similar_indices:
            ...
            song_data['similarity_score'] = similarities[idx]
